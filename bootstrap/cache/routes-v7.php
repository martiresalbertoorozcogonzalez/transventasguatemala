...
app('router')->setCompiledRoutes(
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.contacts.responded',
          ),
          1 => 
          array (
            0 => 'contact',
  ...
  array (
    ...
    'admin.contacts.responded' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'admin/contacts/{contact}/responded',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\ContactController@markAsResponded',
        'controller' => 'App\\Http\\Controllers\\Admin\\ContactController@markAsResponded',
        'as' => 'admin.contacts.responded',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AlertController@create',
        'controller' => 'App\\Http\\Controllers\\AlertController@create',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AlertController@edit',
        'controller' => 'App\\Http\\Controllers\\AlertController@edit',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AlertController@update',
        'controller' => 'App\\Http\\Controllers\\AlertController@update',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AlertController@toggle',
        'controller' => 'App\\Http\\Controllers\\AlertController@toggle',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AlertController@destroy',
